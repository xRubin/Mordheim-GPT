...
use Mordheim\Classic\Attributes\AllowedWarband;
use Mordheim\Classic\Attributes\Characteristics;
use Mordheim\Classic\Attributes\Equipment;
use Mordheim\Classic\Attributes\EquipmentList;
use Mordheim\Classic\Attributes\ExceptWarband;
use Mordheim\Classic\Attributes\Henchman;
use Mordheim\Classic\Attributes\Hero;
use Mordheim\Classic\Attributes\HiredSword;
use Mordheim\Classic\Attributes\HireFee;
use Mordheim\Classic\Attributes\MaxCharacteristics;
use Mordheim\Classic\Attributes\MaxCount;
use Mordheim\Classic\Attributes\MinCount;
use Mordheim\Classic\Attributes\Rating;
use Mordheim\Classic\Attributes\Rule;
use Mordheim\Classic\Attributes\SkillGroup;
use Mordheim\Classic\Attributes\StartExp;
use Mordheim\Classic\Attributes\UpkeepFee;
use Mordheim\Classic\Attributes\Warband;
use Mordheim\Classic\Exceptions\InvalidAttributesException;
...
enum Blank
{
    ...
    public function getWarband(): ?\Mordheim\Classic\Warband
    {
    ...
    public function getAllowedWarbands(): array
    {
        ...
        if (count($classAttributes))
            return array_values(
                array_diff(
                    \Mordheim\Classic\Warband::cases(),
                    array_map(
                        fn($attribute) => $attribute->newInstance()->getValue(),
                        $classAttributes
                    )
        ...
        return \Mordheim\Classic\Warband::cases();
    }
    ...
    public function getEquipmentList(): \Mordheim\Classic\EquipmentList
    {
        $ref = new \ReflectionClassConstant(self::class, $this->name);
